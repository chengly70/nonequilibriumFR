...
switch whSet %assuming same time vectors (tmv)
    case 1 %weakest coupling
        load(['dAn_n50a.mat'],'tmv','Nc','mnX_Ma','mnF_Ma','covF_Ma','covX_Ma')
        load(['dMC_n50a.mat'],'mnX_M','mnF_M','covF_M','covX_M')
    case 2
        load(['dAn_n50b.mat'],'tmv','Nc','mnX_Ma','mnF_Ma','covF_Ma','covX_Ma')
        load(['dMC_n50b.mat'],'mnX_M','mnF_M','covF_M','covX_M')
    case 3
        load(['dAn_n50c.mat'],'tmv','Nc','mnX_Ma','mnF_Ma','covF_Ma','covX_Ma')
        load(['dMC_n50c.mat'],'mnX_M','mnF_M','covF_M','covX_M')
    case 4 %strongest coupling
        load(['dAn_n50d.mat'],'tmv','Nc','mnX_Ma','mnF_Ma','covF_Ma','covX_Ma')
        load(['dMC_n50d.mat'],'mnX_M','mnF_M','covF_M','covX_M')
end
%L1-norm of error
